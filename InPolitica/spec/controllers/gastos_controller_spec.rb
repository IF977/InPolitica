...
RSpec.describe GastosController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "redirects to the created gasto" do
        post :create, {:gasto => valid_attributes}, valid_session
        expect(response).to redirect_to(Gasto.last)
      end
    end

    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, {:gasto => invalid_attributes}, valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested gasto" do
        gasto = Gasto.create! valid_attributes
        put :update, {:id => gasto.to_param, :gasto => new_attributes}, valid_session
        gasto.reload
      ...
      it "redirects to the gasto" do
        ...
        expect(response).to redirect_to(gasto)
      end
    end
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        gasto = Gasto.create! valid_attributes
        put :update, {:id => gasto.to_param, :gasto => invalid_attributes}, valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the gastos list" do
      gasto = Gasto.create! valid_attributes
      delete :destroy, {:id => gasto.to_param}, valid_session
      expect(response).to redirect_to(gastos_url)
    end
  end
