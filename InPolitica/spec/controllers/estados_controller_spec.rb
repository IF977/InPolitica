  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, {:estado => invalid_attributes}, valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested estado" do
        estado = Estado.create! valid_attributes
        put :update, {:id => estado.to_param, :estado => new_attributes}, valid_session
        estado.reload
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        estado = Estado.create! valid_attributes
        put :update, {:id => estado.to_param, :estado => invalid_attributes}, valid_session
        expect(response).to be_success
      end
    end
  end
